        ...
        <section className="w-full h-96 flex justify-center items-center bg-black/50">
          <div>
            ...
            <span className="flex justify-center">
              <Link to="/reservation" className="inline-flex items-center justify-center text-white rounded-md bg-[#d68a3d] px-6 py-3 text-base font-medium text-primary-foreground shadow-sm transition-transform transform hover:translate-y-1 hover:border-transparent cursor-pointer hover:bg-[#a96b2e]">
                Ver Productos
              </Link>
            </span>
          </div>
