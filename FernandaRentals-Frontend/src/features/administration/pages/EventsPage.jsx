...
<div className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-4 lg:ml-0 ml-16">
  ...
  <div className="col-span-12 lg:col-span-8 flex flex-col space-y-4">
    ...
    {/* <Selector   selectedMonthData={selectedMonthData} setIsPickerOpen={setIsPickerOpen} isPickerOpen={isPickerOpen} darkMode={darkMode} setSelectedMonthData={setSelectedMonthData}  /> */}
      ...
      <FinancialReport
        ...
        selectedMonthData={selectedMonthData} setIsPickerOpen={setIsPickerOpen} isPickerOpen={isPickerOpen} darkMode={darkMode} setSelectedMonthData={setSelectedMonthData} 
      />
    </div>
    ...
    function Selector({selectedMonthData, setIsPickerOpen, isPickerOpen, darkMode, setSelectedMonthData}) {
      return (<div>
              <MonthInput selected={selectedMonthData} setShowMonthPicker={setIsPickerOpen} showMonthPicker={isPickerOpen} lang="es" size="small" // Personalización del MonthInput según el tema
  ...
  />
              {isPickerOpen && <MonthPicker size="small" lang="es" setIsOpen={setIsPickerOpen} selected={selectedMonthData} onChange={setSelectedMonthData} // Personalización del MonthPicker según el tema
